    ...
    constructor(canvas){
        ...
        this.init(canvas).then(()=>{
            ...
            if (this.shouldRequestAnimationFrame) {
                ...
                requestAnimationFrame(step);
            } else setInterval(()=>this.update(), this.updateInterval);
        });
    }
}
...
const $c8a6c04c3ac47780$var$PARTICLE_COUNT = $c8a6c04c3ac47780$var$WORKGROUP_SIZE * 1024;
console.log(`${Math.floor($c8a6c04c3ac47780$var$PARTICLE_COUNT / 1000)}k particles`);
...
//# sourceMappingURL=index.291f6bfc.js.map
